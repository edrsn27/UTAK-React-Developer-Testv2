  ...
  return (
    <div>
      <Transition appear show={show} as={Fragment}>
        <div className="absolute top-0 right-0 w-2/3 m-3 md:w-1/3">
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="flex items-start p-3 space-x-2 bg-white border border-gray-300 rounded-md shadow-lg">
              <svg
              ...
              <div className="flex-1 space-y-1">
                ...
                <p className="text-sm leading-5 text-gray-600">{message}</p>
              </div>
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-400 cursor-pointer"
                stroke="currentColor"
                viewBox="0 0 20 20"
